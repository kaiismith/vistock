...
from vistock.core.interfaces.ivistockscraper import (
    ...
    IVistockVnDirectMarketPricesScraper,
    AsyncIVistockVnDirectMarketPricesScraper,
    IVistockVnDirectChangePricesScraper,
    AsyncIVistockVnDirectChangePricesScraper
)
...
class VistockVnDirectMarketPricesScraper(IVistockVnDirectMarketPricesScraper, AsyncIVistockVnDirectMarketPricesScraper):
    def __init__(self, **kwargs: Any) -> None:
...
class VistockVnDirectChangePricesScraper(IVistockVnDirectChangePricesScraper, AsyncIVistockVnDirectChangePricesScraper):
    def __init__(self, **kwargs: Any) -> None:
